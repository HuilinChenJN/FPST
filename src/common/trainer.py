   ...
   and some other features helpful for model training and evaluation.
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None):
        ...
        for batch_idx, interaction in enumerate(train_data):
            ...
            if epoch_idx % 5 == 0 and batch_idx == 0:
                self.logger.info(f'Epoch {epoch_idx} Batch {batch_idx} Losses: {losses}')
                # print(f'textual to id {self.model.user_t_bar[0]} visual to id {self.model.user_v_bar[0]} ')
                # self.logger.info(f'weight value: {self.model.weight_i}')

            # if epoch_idx % 1 == 0 and batch_idx == 0:
            #     swanlab.log(dict(losses))
    ...
    def fit(self, train_data, valid_data=None, test_data=None, saved=False, verbose=True):
        ...
        """
        # self.model.set_missing_feat_for_evaluation(valid_data, test_data)
